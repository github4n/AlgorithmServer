...
def addOneTimes():
    ...
    param = [TODAY_CRAWLING_TIMES,THREE_HOURS_CRAWLING_TIMES,HAVE_ACQUIRED_ALL,QichachaEnum.USER_FLAG_TRUE,QichachaEnum.IS_LOGIN_NOW_TRUE]
    row = poHelper.update(update_sql, params=param)
